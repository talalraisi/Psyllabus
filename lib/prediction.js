...
export function predictDiploma({ profile, syllabusRows = [], effectiveMap = {} }) {
  ...
  return {
    ...
    // A target is a claim about what the student is aiming for, and they do
    // aim for a TOK and EE grade. So unlike the prediction, the target total
    // includes the core: six subjects out of 42, plus up to 3, out of 45.
    // Leaving it out was how the page ended up listing a +3 bonus directly
    // above a total of 42 out of 42.
    targetDiplomaTotal: targetPoints + (targetBonus || 0),
