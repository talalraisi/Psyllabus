...
import { HOW_IT_WORKS, WHY, FEATURE_DETAIL } from '@/components/marketing/content'
...
export default function FeaturesPage() {
  return (
    <PageShell>
      ...
      {/* The slideshow above is for deciding whether to keep reading. This is
          for deciding whether to sign up, which is a different question and
          needs the mechanism rather than the pitch — including where each one
          stops, because a page that lists only capabilities is a page you
          cannot trust about capabilities. */}
      <Band tint>
        ...
        <p className="mt-4 max-w-xl text-[15px] leading-relaxed" style={{ color: 'var(--text-body)' }}>
          How each one actually works, and what it will not do.
        </p>
            ...
            >
              <div className="grid gap-6 md:grid-cols-[minmax(0,17rem)_1fr] md:gap-12">
                <div>
                  ...
                  <h3 className="mt-3 text-[19px] font-semibold leading-snug tracking-[-0.022em]">
                    {f.title}
                  </h3>
