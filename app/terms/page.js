      ...
      <div className="max-w-2xl mx-auto px-5 py-12 md:py-16">
        ...
        <div className="space-y-8 text-sm text-[var(--text-body)] leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              We do <strong className="font-medium text-[var(--text)]">not</strong> reproduce, host, or
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text)] mb-2">No guarantee of results</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text)] mb-2">Accuracy</h2>
            <p>
